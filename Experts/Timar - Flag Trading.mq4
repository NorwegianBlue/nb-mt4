...
extern string _VERSION_13 = VERSION_STR;
...
extern double MaxStop_Pips = 0.0;
...
void _EnterNow()
{
  ...
  {
    OrderSelect(ticket, SELECT_BY_TICKET);
    // TODO: work out what price we achieved, and adjust stop and TP for that
